...
const Reports = ({navigation, route}) => {
    ...
    const updateValue = (period) => {
        ...
        fetch(api_url + "member_transaction_api/viewWithdrawalHistory", {
            method: "POST",
            body: p_data,
            headers: new Headers({
    ...
    return (
        <View style={{flex: 1, height: "100%"}}>
            ...
            >
                <HeaderMenu navigation={navigation} back="Reports" title="Withdrawal Report"/>
                <View style={{paddingBottom: 30}}>
                    ...
                    <View
                        style={{flex: 1, flexDirection: 'row', flexWrap: "wrap", marginTop: 10, marginHorizontal: 15}}>
                        <View style={{width: "100%"}}>
